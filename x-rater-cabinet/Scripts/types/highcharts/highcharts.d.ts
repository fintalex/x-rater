...
interface HighchartsChartOptions {
	...
	marginRight?: number;
	marginTop?: number;
	plotBackGroundColor?:  HighchartsGradient;
...
interface HighchartsPaneOptions {
	...
	center: any; // [x,y] | ["50%","50%" ] --  Edit By Alex Kharchenko
    endAngle?: number;
	size?: string;
	startAngle?: number;
}
...
interface HighchartsAreaChart {
	...
	pointPlacement?:  number; // null, "on", "between"
	pointStart?: number;
	selected?: boolean;
	shadow?:  HighchartsShadow;
...
interface HighchartsIndividualSeriesOptions {
	data?: HighchartsDataPoint[]; // [value1,value2, ... ] | [[x1,y1],[x2,y2],... ] | HighchartsDataPoint[] --  Edit By Alex Kharchenko
	index?: number;
	legendIndex?: number;
	name?: string;
...
interface HighchartsSeriesOptions extends HighchartsSeriesChart {
	type?: string;
	data?: HighchartsDataPoint[]; //  --  Edit By Alex Kharchenko
	index?: number;
	legendIndex?: number;
	name?: string;
	stack?:  number;
...
interface HighchartsTooltipOptions {
	...
	borderRadius?: number;
	borderWidth?: number;
	crosshairs?: any; //--  Edit By Alex Kharchenko
    enabled?: boolean;
	footerFormat?: string;
	formatter?: () => any;
	pointFormat?: string;
...
interface HighchartsAxisObject {
	...
	setExtremes(min: number, max: number, redraw: boolean, animation:  HighchartsAnimation): void;
...
interface HighchartsChartObject {
	...
	get(id: string): any; // --  Edit By Alex Kharchenko
	getSVG(): string;
...
interface HighchartsStatic {
	...
	Color(color:  HighchartsGradient):  HighchartsGradient;
...
interface HighchartsSeriesObject {
	addPoint(options: HighchartsDataPoint): void; // --  Edit By Alex Kharchenko
	addPoint(options: HighchartsDataPoint, redraw: boolean, shift: boolean): void; // --  Edit By Alex Kharchenko
	addPoint(options: HighchartsDataPoint, redraw: boolean, shift: boolean, animation: boolean): void; // --  Edit By Alex Kharchenko
	addPoint(options: HighchartsDataPoint, redraw: boolean, shift: boolean, animation: HighchartsAnimation): void; // --  Edit By Alex Kharchenko
